            ...
            <div style={this.props.style} className='footer-parent'>
                <div className='footer-introduce'>
                    ...
                    <div className='fi-list-icons'>
                        <img onClick={this.clickFacebook} src='./src/assets/facebook-icon.png' alt='facebook' />
                        <img onClick={this.clickYoutube} src='./src/assets/youtube-icon.png' alt='youtube' />
                        <img onClick={this.clickTwitter} src='./src/assets/twitter-icon.png' alt='twitter' />
                        <img onClick={this.clickInstagram} src='./src/assets/instagram-icon.png' alt='instagram' />
                    </div>
                </div>
